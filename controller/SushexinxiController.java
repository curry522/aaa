...
public class SushexinxiController {
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        EntityWrapper<SushexinxiEntity> ew = new EntityWrapper<SushexinxiEntity>();
        List<Map<String, Object>> result = sushexinxiService.selectValue(params, ew);
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        EntityWrapper<SushexinxiEntity> ew = new EntityWrapper<SushexinxiEntity>();
        List<Map<String, Object>> result = sushexinxiService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        EntityWrapper<SushexinxiEntity> ew = new EntityWrapper<SushexinxiEntity>();
        List<Map<String, Object>> result = sushexinxiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,SushexinxiEntity sushexinxi, HttpServletRequest request){
        EntityWrapper<SushexinxiEntity> ew = new EntityWrapper<SushexinxiEntity>();
        int count = sushexinxiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, sushexinxi), params), params));
